...
<div className="w-[100%] flex justify-center align-middle self-center pt-5">
  <button type="button" className=" bg-yellow-300 m-auto hover:bg-orange-500 px-3 py-2 rounded-lg text-black hover:text-white transition-all font-serif font-semibold text-[16px] self-center text-center">View Item</button>
  </div>
        </div>
